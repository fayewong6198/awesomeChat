export const transValidation = {
  ...
  update_username:
    "Tên người dùng giới hạn trong khoảng 3-17 ký tự và không được phép chứa ký tự đặt biệt.",
  ...
  message_text_emoji_incorrect:
    "Tin nhắn không hợp lệ. Tối thiểu 1 ký tự, tối đa 500 ký tự.",
...
export const transSuccess = {
  ...
  reset_password_success: "Tạo mật khẩu mới thành công",
};
